...
public class SQLiteDialect extends Dialect {
	 ...
	 * return true; // temporary tables are only dropped when the connection is
	...
	public SQLExceptionConversionDelegate buildSQLExceptionConversionDelegate() {
		return new SQLExceptionConversionDelegate() {
			...
			public JDBCException convert(SQLException sqlException, String message, String sql) {
				...
				else if ((errorCode >= SQLITE_IOERR && errorCode <= SQLITE_PROTOCOL) || errorCode == SQLITE_NOTADB) { return new JDBCConnectionException(message, sqlException, sql); }
	...
	private static final ViolatedConstraintNameExtracter EXTRACTER = new TemplatedViolatedConstraintNameExtracter() {
		...
		protected String doExtractConstraintName(SQLException sqle) throws NumberFormatException {
			...
			if (errorCode == SQLITE_CONSTRAINT) { return extractUsingTemplate("constraint ", " failed", sqle.getMessage()); }
			return null;
		}
	};
