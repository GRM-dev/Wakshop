...
public class WorkshopDetailsController extends GridPane implements Focusable {
	...
	private WorkshopManageViewController controller;
	
	public WorkshopDetailsController(Workshop workshop, WorkshopManageViewController controller) throws IOException {
	...
	private void saveButton_Click(ActionEvent e) {
		...
		workshop = Workshop.save(workshop);
	...
	private void removeButton_Click(ActionEvent e) {
		...
		controller.removeWorkshop(workshop);
	}
}
